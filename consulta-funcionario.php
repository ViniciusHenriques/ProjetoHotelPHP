...
<html lang="pt-br">
  <head>
    <meta charset="utf-8">
    <title>Hotel - Consulta Funcionário</title>
      ...
      <div class="table-responsive">
        <table class="table table-striped table-bordered bg-link table-hover table-condensed">
          ...
          <tbody>
            ...
            $array2 = $funDAO->buscarIdFunc($login);
            foreach ($array2 as $b) {
              $idFun = $b->idFuncionario;
            }
            foreach($array as $a){
              ++$id;
              echo "<tr class='active'>";

              if($a->idFuncionario == $idFun){
                echo "<td><a href='alterar-funcionario.php?id=$a->idFuncionario'><img src='imagens/alterar.png' title='Alterar'></a></td>";
                echo "<td><a href='#'><img src='imagens/bloq.png' title='Este funcionario não pode ser excluido'></td>";
                                ...
                                <div class='modal-dialog'>
                                     <div class='modal-content'>
                                         ...
                                         <div class='modal-body'>
                                             <p>Tem certeza que deseja excluir o Funcionario número $a->idFuncionario ?</p>
                                         </div>
                                         <div class='modal-footer'>
                                             <a class='btn btn-danger col-md-3 col-md-offset-3' href='consulta-funcionario.php?id=$a->idFuncionario'>SIM</a>
